...
export default function Footer() {
  return (
    <div className={`${styles.footer} w-full lg:h-[50vh] sm300:h-[50vh] sm500:h-[18vh] bg-[#E6F0EC]   flex flex-col items-center justify-between  lg:p-6 sm300:p-6 sm500:p-5 box-border  font-Encode `}>
      <div className="lg:w-[53%] sm500:w-[95%] sm300:w-[80%] lg:h-[100%] sm300:h-[100%] bg-[#E6F0EC] flex lg:flex-col sm500:flex-col sm300:flex-col lg:items-center sm300:items-center sm500:items-center justify-around  ">
        <div className="lg:w-[100%] sm500:w-[100%]   sm300:w-[100%] lg:h-[50%] sm500:h-[50%] sm300:h-[50%]  flex lg:flex-col sm500:flex-col sm300:flex-col items-center justify-center">
          <img
            ...
            alt=""
            className={`${styles.logo} lg:w-[10%] sm500:w-[20%] sm300:w-[30%] sm300:h-[50%] lg:h-[100%]`}
          />
          <h1 className={`${styles.title} lg:text-[35px] sm300:text-[22px] font-bold text-[#004E2B] lg:mt-1 sm300:mt-2 sm500:mt-2`}>
            ENVROPACK
          </h1>
        </div>
