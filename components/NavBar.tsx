    ...
    <div className="w-full lg:h-[20%] sm500:h-[20%] sm300:h-[30%] bg-transparent flex  flex-row items-center lg:justify-between sm300:justify-start  lg:absolute sm500:absolute font-Encode  ">
      <div className="lg:w-[40%]  sm300:w-[90%] h-full flex flex-row items-center lg:justify-start   lg:ml-[115px] sm500:ml-8 sm300:ml-3 ">
        <img
          ...
          alt=""
          className="lg:w-[12%] sm300:w-[15%] sm500:w-[12%]  h-full"
        />
        <h1 className="lg:text-[35px] sm300:text-[22px] sm500:text-[40px] font-bold text-[#004E2B]  lg:ml-4 sm300:ml-2 sm500:ml-6">
          ENVROPACK
        </h1>
      </div>
