...
export default function Service() {
  return (
    <div className="w-full lg:h-[80%] sm500:h-[100%] sm300:h-[100%] flex lg:flex-row sm500:flex-row sm300:flex-col  items-center justify-around lg:mt-0 sm300:mt-4 sm500:mt-6 ">
      <div className="lg:w-[15%] sm300:w-[45%] sm500:w-[20%] lg:h-full sm500:h-[100%]  flex flex-col items-center justify-start   ">
      ...
      <div className="lg:w-[15%] sm300:w-[45%] sm500:w-[20%]  sm500:h-[100%] lg:h-full flex flex-col items-center justify-start lg:mt-0 sm300:mt-4 sm500:mt-0 sm500:mt-0">
      ...
      <div className="lg:w-[15%] sm300:w-[45%] sm500:w-[20%]  sm500:h-[100%] lg:h-full flex flex-col items-center justify-start lg:mt-0 sm300:mt-4 sm500:mt-0 ">
