...
export default function Service() {
  return (
    <div
      className={`${styles.service} w-full lg:h-[80%] sm500:h-[100%] sm300:h-[100%] flex lg:flex-row sm500:flex-row sm300:flex-col  items-center lg:justify-between sm500:justify-between sm300:justify-around lg:mt-0 sm300:mt-8 sm500:mt-6 `}
    >
