...
export default function ThirdSection() {
  return (
    <div className={`${styles.thirdSection} w-full lg:h-[100vh]  sm500:h-[35vh] sm300:[100vh] flex flex-col items-center justify-between lg:mt-10 sm500:mt-0 font-Encode  sm300:mt-10`}>
      <div className="w-[88%] lg:h-[40%]  sm300:h-[40%] sm500:h-[40%] flex flex-col lg:items-start sm500:items-start  sm300:items-center justify-start">
        <h1 className={` ${styles.head1} lg:text-[30px] sm300:text-[20px]  sm500:text-[25px] text-[#004E2B] text-left font-bold`}>
          More reason to trust us...
        </h1>
        <Quality />
      </div>
      <div className={` ${styles.section} w-[88%] h-[55%]  flex lg:flex-row sm300:flex-col sm500:flex-row lg:items-start sm500:items-start sm300:items-center justify-center sm300:mt-8  lg:mt-0 `}>
        <div className="lg:w-[50%]  sm500:w-[50%] sm300:w-[100%] h-[75%]  flex flex-col lg:items-start sm500:items-start sm300:items-center sm:justify-between lg:justify-start ">
          <h1 className={`${styles.head} lg:text-[30px] sm300:text-[20px] sm500:text-[25px] text-[#004E2B] lg:text-left sm500:text-left sm300:text-center font-bold`}>
            Envropack care about the nature
          </h1>
          <h1 className={`${styles.sub} lg:text-[20px]  sm300:text-[13px] sm500:text-[15px] text-[#004E2B] lg:text-left sm500:text-left sm300:text-center font-light sm300:mt-2 lg:mt-4 lg:tracking-wider`}>
