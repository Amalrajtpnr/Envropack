...
export default function ThirdSection() {
  return (
    <div
      className={`${styles.thirdSection} w-full lg:h-[100vh]  sm500:h-[35vh] sm300:[100vh] flex flex-col items-center justify-between lg:mt-10 sm500:mt-0 font-Encode  sm300:mt-10`}
    >
      <div className="w-[88%] lg:h-[40%]  sm300:h-[40%] sm500:h-[40%] flex flex-col lg:items-start sm500:items-start  sm300:items-center justify-start">
        <h1
          className={` ${styles.head1} lg:text-[30px] sm300:text-[20px]  sm500:text-[25px] text-[#004E2B] text-left font-bold`}
        >
      ...
      >
        <div className="lg:w-[50%]  sm500:w-[50%] sm300:w-[100%] h-[75%]  flex flex-col lg:items-start sm500:items-start sm300:items-center sm:justify-between lg:justify-start  ">
          <h1
            className={`${styles.head} lg:text-[30px] sm300:text-[20px] sm500:text-[25px] text-[#004E2B] lg:text-left sm500:text-left sm300:text-center font-bold`}
          >
        ...
        <img
          src="https://firebasestorage.googleapis.com/v0/b/envropack-14c71.appspot.com/o/plantmb.jpg?alt=media&token=8b6d6daf-8ccf-4e3f-b029-fff816c75048&_gl=1*jinok5*_ga*MTg4NzMzNTA0LjE2OTg5MjkzMjM.*_ga_CW55HF8NVT*MTY5OTAyODY5Ni41LjEuMTY5OTAyOTQxMy42MC4wLjA."
          alt=""
          className="lg:w-[50%] sm300:w-[100%] h-[100%] lg:hidden  sm500:hidden"
        />
        <img
          src="https://firebasestorage.googleapis.com/v0/b/envropack-14c71.appspot.com/o/plant.jpg?alt=media&token=d4eb77d1-c907-4ff0-9909-24ce32f485ae&_gl=1*ck7tku*_ga*MTg4NzMzNTA0LjE2OTg5MjkzMjM.*_ga_CW55HF8NVT*MTY5ODkzNTk1Ny4zLjEuMTY5ODkzNjI0My41My4wLjA."
          alt=""
          className="lg:w-[50%] sm300:w-[100%] sm500:w-[50%] h-[100%] lg:flex sm300:hidden sm500:flex"
        />
      </div>
    </div>
  );
