    ...
    <div id="home" className={`${styles.landing} lg:w-full sm500:w-full sm300:w-full lg:h-[100vh] sm300:h-[110vh] sm500:h-[35vh]    flex lg:flex-row sm500:flex-row sm300:flex-col lg:items-start sm500:items-start sm300:items-center lg:justify-end sm500:justify-end sm300:justify-between lg:relative sm500:relative sm300:relative `}>
      ...
      <div className={`${styles.section} lg:w-[60%] sm300:w-full sm500:w-[55%] lg:h-full sm500:h-full sm300:min-h-[50%] flex flex-col items-center justify-center  `}>
        <div className="lg:w-[80%] sm500:w-[90%] sm300:w-[85%]  lg:h-full sm300:h-full flex flex-col lg:items-start sm300:items-center sm500:items-start lg:justify-end sm300:justify-center sm500:justify-end   ">
          ...
          <h1 className={`${styles.sub} lg:text-[20px] text-[#004E2B] sm300:text-[13px] sm500:text-[18px]  lg:text-left sm300:text-center sm500:text-left  font-light  lg:mt-6 lg:mb-3 sm300:mt-2 sm500:mt-4 font-Encode `}>
          ...
          <div className="w-[80%] h-[20%] flex flex-row items-start justify-between font-Encode ">
            <div className="w-[25%] h-full flex flex-col items-start justify-center ">
              <h1 className={`lg:text-[35px] sm300:text-[18px]  sm500:text-[25px]   text-left font-bold text-[#062701] ${styles.head} `}>10+</h1>
              <h1 className={`lg:text-[19px] sm300:text-[13px] sm500:text-[20px] text-left  font-light text-[#004E2B] ${styles.sub}`}>Countries</h1>
            </div>
            <div className="w-[25%] h-full flex flex-col items-start justify-center ">
              <h1 className={`lg:text-[35px] sm300:text-[9] sm500:text-[25px]   text-left font-bold text-[#062701] ${styles.head}`}>10K+</h1>
              <h1 className={`lg:text-[19px] sm300:text-[13px] sm500:text-[20px] text-left font-light text-[#004E2B]  ${styles.sub}`}>Clients</h1>
            </div>{" "}
            <div className="w-[25%] h-full flex flex-col items-start justify-center ">
              <h1 className={`lg:text-[35px] sm300:text-[18px] sm500:text-[25px]   text-left font-bold text-[#062701] ${styles.head}`}>1000+</h1>
              <h1 className={`lg:text-[19px] sm300:text-[13px] sm500:text-[20px] text-left font-light text-[#004E2B] ${styles.sub}`}>Products</h1>
            </div>
          </div>
        </div>
      </div>
