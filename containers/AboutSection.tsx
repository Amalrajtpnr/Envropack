...
export default function AboutSection() {
  return (
    <div
      id="about"
      className="w-full lg:h-[100vh] sm300:h-[150vh] sm500:h-[100vh] sm550:h-[150vh] flex flex-col items-center justify-start sm300:p-0 lg:p-0 sm500:p-6 sm500:box-border"
    >
      <div className="w-full h-[50%] flex lg:flex-row sm300:flex-col items-center sm300:justify-start lg:justify-center ">
        <div className="lg:w-[52%] sm300:w-[95%] lg:h-full sm300:h-[50%] flex flex-col lg:items-start sm300:items-center justify-start   sm300:mt-4 lg:mt-0">
          <h1 className="lg:text-[30px] sm300:text-[20px] sm500:text-[40px] lg:text-left sm300:text-center  text-[#004E2B] font-bold">
            What is ENVROPACK
          </h1>
          <h1 className="lg:text-[20px] sm300:text-[15px] lg:text-left sm500:text-[25px] sm300:text-center sm300:leading-relaxed text-left font-light lg:mt-4 sm300:mt-2">
      ...
      <div className="w-full h-[50%] flex flex-col items-center justify-center sm300:mt-8 lg:mt-0  ">
        <div className="w-[88%] h-full flex lg:flex-row sm300:flex-col items-start justify-between ">
          ...
          <div className="lg:w-[60%] lg:h-full sm300:h-full flex flex-col items-start justify-center sm500:mt-6 sm300:mt-0 lg:mt-0">
            ...
            <img src="/images/cup.jpg" alt="" className="w-[100%] sm500:mt-6 sm300:mt-0 lg:mt-0 h-[80%] sm300:flex lg:hidden" />
